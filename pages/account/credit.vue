<template>
    <view class="page-container">
        <u-navbar :is-back="false" title="我的蟹币" title-size="32" title-color="#333" z-index="99999" :border-bottom="false">
            <view class="navbar">
        ...
        <view class="money-top">
            ...
            <view class="money-rule flex flex-column-center" @tap="toRule">
                <text class="rule-text">蟹币说明</text>
            ...
            <view class="money-account-container">
                <view class="account-top flex flex-column-center flex-row-between">
                    ...
                    <view class="button-more">
                        <button class="flex flex-column-center" hover-class="active" @tap="toTask">
                            <text class="button-text">获得更多</text>
                            <u-icon class="button-icon" name="arrow-right"></u-icon>
                        </button>
                    </view>
                </view>
                <view class="account-number">{{ credit }}</view>
            </view>
        </view>
        ...
        onLoad() {
            this.$common.getCustomer(this, data => {
				if (this.$common.isNotEmpty(data)) {
                    if (this.$common.isNumber(data.integral)) {
                        this.credit = parseFloat(data.integral);
                    }
